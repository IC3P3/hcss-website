...
<svg class={classes} fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
	<path
...
<span class="sr-only">WhatsApp Kanal der Helmstedter Chor- und Singschule</span>
