...
<svg class={classes} fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
	<path
...
<span class="sr-only">Facebook Seite der Helmstedter Chor- und Singschule</span>
