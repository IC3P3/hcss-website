...
<svg class={style} fill="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
	<path
...
<span class="sr-only">Soundcloud Seite der Helmstedter Chor- und Singschule</span>
